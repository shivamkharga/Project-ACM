...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class="text">
                <div class="welcome" id="books"> <img style="width:30px;margin-right:15px;"src="/resources/images/Books.png">Books</div>
                    <div  id="desc">
                        <a href="http://www.acm.org/education/learning-center">
                            <div class="image-box">
                                <img class="image" src="/resources/images/acm_dl.png">
                                <div class="image-cap">ACM Digital Library</div>
                            </div>
                        </a>
                        
                        <a href="http://www.allitebooks.com/">
                            <div class="image-box">
                                <img class="image" src="/resources/images/owl-logo.png">
                                <div class="image-cap">All IT eBooks</div>
                            </div>
                        </a>
                        
                        <a href="http://it-ebooks.info/tag/programming/">
                            <div class="image-box">
                                <img class="image" src="/resources/images/it_ebook.png">
                                <div class="image-cap">IT eBooks</div>
                            </div>
                        </a>
                        
                        <a href="https://github.com/EbookFoundation/free-programming-books/blob/master/free-programming-books.md#ada">
                            <div class="image-box">
                                <img class="image" src="/resources/images/ebook_foundation.png">
                                <div class="image-cap">Ebook Foundation</div>
                            </div>
                        </a>
                </div>
            </div>
